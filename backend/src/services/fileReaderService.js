...
import { extractEntriesFromPDFText } from "../utils/pdfParser.js";
...
export async function readFileContent(filePath) {
  try {
    ...
    const entries = extractEntriesFromPDFText(result.text);

    return entries;
  } catch (error) {
    console.error("Erro ao ler o arquivo PDF:", error.message);
    throw new Error("Falha na leitura do arquivo PDF");
  }
}
